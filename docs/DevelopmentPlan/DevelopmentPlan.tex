...
\begin{enumerate}
  \item Real-time analytics may be too computationally complex. We will reduce data frequency or adopt data sorting algorithms if needed.
...
\begin{itemize}
  ...
  \item Generalizability to different lecture hall setups. Mitigation: design flexible dashboard components that are able to adapt to various locations.
\end{itemize}
