...
We will demonstrate the instructor dashboard, building on the existing proof-of-concept, with several key enhancements. These include real-time data updates within the dashboard, an instructor coordinate tracking feature, and homography-based gaze projection integrated directly into the dashboard view.
...
\noindent \textbf{Supervisor's Name: } Dr. Lauren Fink and Dr. Irene Yuan
